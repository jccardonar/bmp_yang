...
Note: Should we cite the tcp: in the model or in the draft as the one providing the connecitity details of tcp? there is nothing to force in the model to use it.
